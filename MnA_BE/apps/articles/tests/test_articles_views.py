...
class ArticlesViewTest(SimpleTestCase):
    ...
    def setUp(self):
        ...
        self.mock_s3_data = {
            "metadata": {"total_collected": 3, "start_time": "2025-10-23T10:00:00+09:00"},
            "articles": [
                {
    ...
    def test_get_detail_with_date_param(self, mock_exists, mock_s3):
        ...
        res = self.client.get(reverse("articles-detail", kwargs={"id": 1}) + "?date=2025-10-23")
        self.assertEqual(res.status_code, 200)
        data = res.json()
    ...
    def test_get_root_empty_articles(self, mock_exists, mock_s3):
        ...
        empty_data = {"metadata": {"total_collected": 0}, "articles": []}
