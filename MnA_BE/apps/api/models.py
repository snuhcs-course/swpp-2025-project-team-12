...
class RecommendationBatch(models.Model):
    ...
    industry_tag = models.CharField(
        max_length=64, null=True, blank=True
    )  # level=industry일 때 필수
    ...
    def __str__(self):
        return (
            f"{self.market_date} {self.level} {self.risk_profile or '-'} {self.industry_tag or '-'}"
        )
...
class RecommendationItem(models.Model):
    ...
    expected_direction = models.CharField(
        max_length=10, choices=Direction.choices, default=Direction.NEUTRAL
    )
    ...
    class Meta:
        ...
        constraints = [
            ...
            models.CheckConstraint(
                check=models.Q(conviction__gte=0.0) & models.Q(conviction__lte=1.0),
