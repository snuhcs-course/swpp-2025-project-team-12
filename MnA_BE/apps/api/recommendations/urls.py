...
urlpatterns = [
    ...
    path('general/<str:year>/<str:month>/<str:day>', GeneralRecommendationsView.as_view({
        'get': 'recommendations_general'
    ...
    path('personalized/<str:year>/<str:month>/<str:day>', PersonalizedRecommendationsView.as_view({
        'get': 'recommendations_personalized'
